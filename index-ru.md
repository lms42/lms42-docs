...
Для того, чтобы попасть в интерфейс учителя, вам необходимо залогинться под административным (учительским) логином. После успешного входа в навигационной панели в выпадающем меню под вашим именем появится пункт "Администрирование":
...
Группы позволяют проводить массовые операции над группой учеников. К примеру, в разделе "Группы" вы можете просмотреть сводную статистику по ученикам какой-либо группы. Смотреть статистику по каждому ученику отдельно было бы гораздо менее удобно.
...
> Кстати, список заданий доступен и в отдельном разделе в верхней панели "Курсы&nbsp;—>&nbsp;Задания". Там они не сгруппированы по урокам, а просто выведены единой таблицей.
